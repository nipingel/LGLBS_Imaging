...
output_name_1=${ms_name_1}
output_name_2=${ms_name_2}
...
if [ "$1" -lt "10" ]; then
       output_name_1=${ms_name_1}"_chan00"$1
       output_name_2=${ms_name_2}"_chan00"$1
fi
if [ "$1" -lt "100" ] && [ "$1" -gt "9" ]; then
	output_name_1=${ms_name_1}"_chan0"$1
	output_name_2=${ms_name_2}"_chan0"$1
fi

# make casa call to imaging script
casa --logfile ${output_name}".log" -c image_channel.py -v ${ms_name_1} -o ${output_name_1} -r ${ra_phase_center_1} -d${dec_phase_center_1}
casa --logfile ${output_name}".log" -c image_channel.py -v ${ms_name_2} -o ${output_name_2} -r ${ra_phase_center_2} -d${dec_phase_center_2}
...
mv ${output_name_1}".tar" /projects/vla-processing/images/${src_name}/single_field_imaging
mv ${output_name_2}".tar" /projects/vla-processing/images/${src_name}/single_field_imaging
## clean up 
rm -rf ${output_name_1}*
rm -rf ${output_name_2}*