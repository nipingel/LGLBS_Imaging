...
a = ['16B-236.sb32623829.eb32998154.57703.975014375.speclines.ms.split_spw.transformed.contsub.split_concat',
...
b = ['17B-162.sb34051874.eb34497862.58019.12101613426.speclines.ms.split_spw.transformed.contsub.split_concat',
...
c = ['14B-088.sb29701604.eb29882607.56952.08797296297.speclines.ms.split_spw.transformed.contsub.split_concat',
...
d = ['20A-346.sb42432794.eb42523325.59804.22769546296.speclines.ms.split_spw.transformed.contsub.split_concat',
...
def get_ms_list(config_pair):
	if config_pair == 'A':
		...
		ms_list = [path + element for element in a]
		return ms_list
	elif config_pair == 'B':
		ms_list = [path + element for element in b]
		return ms_list
	elif config_pair == 'C':
		ms_list = [path + element for element in c]
		return ms_list
	elif config_pair == 'D':
		ms_list = [path + element for element in d]
		return ms_list
	elif config_pair == 'A+B':
