...
output_name=${ms_name}"_mosaic_test"
...
mpicasa -n 6 casa --logfile ${output_name}".log" -c image_channel.py -v ${ms_name} -o ${output_name} -r ${ra_phase_center} -d${dec_phase_center}
