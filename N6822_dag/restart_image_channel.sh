...
## untar previous tclean products to working directory
tar -xvf /projects/vla-processing/images/${src_name}/${output_name}.tar --directory .
...
#fi
## TODO: ADD IF STATEMENT FOR CHANNELS BETWEEN 100 and 999

# make casa call to imaging script
/casa-6.5.0-15-py3.8/bin/casa --logfile ${output_name}".log" -c restart_image_channel.py -v ${ms_name} -o ${output_name} -r ${ra_phase_center} -d${dec_phase_center}
...
mv -f ${output_name}.tar /projects/vla-processing/images/${src_name}
