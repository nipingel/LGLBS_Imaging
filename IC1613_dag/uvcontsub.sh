...
/casa-6.5.0-15-py3.8/bin/casa --nologfile -c uvcontsub.py -n ${ms_name} -o 1 -v ${v_sys} -w ${v_width}
...
mv ${ms_name}".contsub" /projects/vla-processing/measurement_sets/${src_name}
