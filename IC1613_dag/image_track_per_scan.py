"""
5/04/2023
Image LGLBS source around user provided phase center for given observation ID and scan ID
User inputs:
...
-i --obs_id - <required> observation ID number
-s --scan_id - <required> scan ID number
...
parser.add_argument('-i', '--obs_id', help = '<required> observation ID number', required = True)
parser.add_argument('-s', '--scan_id', help = '<required> scan ID number', required = True)
