...
tar -xvf /projects/vla-processing/images/dwarfs_OH/${src_name}/${transition}MHz/${root_file_name}_robust1.0_chan${chan}.tar --directory .

## export to FITS
casa --nologfile --log2term --nogui -c export_fits.py -n ${root_file_name}_robust1.0_chan${chan}.${file_suffix}

## move untarred file back to staging area
mv ${root_file_name}_robust1.0_chan${chan}.${file_suffix}.fits /projects/vla-processing/images/dwarfs_OH/${src_name}/${transition}MHz/${output_name}.fits
