...
tar -xvf /projects/vla-processing/images/dwarfs_OH/${src_name}/${root_file_name}_robust1.0_chan${chan}.tar --directory .

## export to FITS
casa --nologfile --log2term --nogui -c export_fits.py -n ${root_file_name}_robust1.0_chan00${chan}.${file_suffix}

## move untarred file back to staging area
mv ${root_file_name}_robust1.0_chan00${chan}.${file_suffix}.fits /projects/vla-processing/images/dwarfs_OH/${src_name}/${output_name}.fits
